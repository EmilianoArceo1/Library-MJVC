...
type Reader = { id:string; name:string; pages:number; role:"reader"|"admin"; now:string|null; color:string };
type ForumPost = { id:number; user:string; book:string; time:string; text:string; likes:number; replies:number; color:string };
