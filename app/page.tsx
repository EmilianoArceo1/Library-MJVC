...
const books: Book[] = [
  {id:1,title:"El jardín secreto",author:"Frances Hodgson Burnett",year:1911,pages:368,type:"Novela",color:"#b63d2f",cover:"linear-gradient(145deg,#274b3d,#6f9b6b)",synopsis:"Una casa enorme, un jardín cerrado y dos niños que aprenden que cuidar algo también puede transformarlos.",rating:4.8,available:1,copies:1,readers:["Elena","Mateo","Sofía"]},
  {id:2,title:"El principito",author:"Antoine de Saint-Exupéry",year:1943,pages:96,type:"Cuento",color:"#e4ad3b",cover:"linear-gradient(145deg,#12354b,#2d7794)",synopsis:"Un pequeño viajero recorre planetas y descubre, entre encuentros inolvidables, aquello que de verdad importa.",rating:4.9,available:0,copies:1,readers:["Julia","Leo","Mara"]},
  {id:3,title:"Momo",author:"Michael Ende",year:1973,pages:304,type:"Novela",color:"#2d7c73",cover:"linear-gradient(145deg,#7c2636,#d35b4d)",synopsis:"Momo sabe escuchar como nadie. Cuando los hombres grises roban el tiempo, esa sencilla virtud se vuelve extraordinaria.",rating:4.7,available:1,copies:2,readers:["Noa","Elena"]},
  {id:4,title:"National Geographic Kids",author:"Varios autores",year:2024,pages:48,type:"Revista",color:"#d2823b",cover:"linear-gradient(145deg,#123f36,#d3a83d)",synopsis:"Curiosidades sobre animales, naturaleza y ciencia para lectores con muchas preguntas.",rating:4.5,available:2,copies:2,readers:["Mateo"]},
  {id:5,title:"Matilda",author:"Roald Dahl",year:1988,pages:240,type:"Novela",color:"#745a9c",cover:"linear-gradient(145deg,#493362,#b45e75)",synopsis:"Una lectora brillante descubre que su inteligencia y su valentía pueden cambiar las reglas del mundo adulto.",rating:4.8,available:1,copies:1,readers:["Sofía","Julia"]},
  {id:6,title:"Donde viven los monstruos",author:"Maurice Sendak",year:1963,pages:48,type:"Álbum ilustrado",color:"#3a8d63",cover:"linear-gradient(145deg,#213644,#cf8c3c)",synopsis:"Max navega hasta la tierra de los monstruos y descubre que siempre hay un lugar que lo espera.",rating:4.9,available:1,copies:1,readers:["Leo","Noa"]},
  {id:7,title:"Cuentos de buenas noches",author:"Elena Favilli",year:2016,pages:224,type:"Biografía",color:"#c95064",cover:"linear-gradient(145deg,#8a305f,#e69158)",synopsis:"Cien historias breves de mujeres que convirtieron su curiosidad en caminos nuevos.",rating:4.6,available:1,copies:1,readers:["Mara"]},
  {id:8,title:"La historia interminable",author:"Michael Ende",year:1979,pages:496,type:"Novela",color:"#315f86",cover:"linear-gradient(145deg,#3b214e,#b37838)",synopsis:"Un libro misterioso invita a Bastián a entrar en Fantasía y a descubrir su propia voz.",rating:4.9,available:1,copies:1,readers:["Elena","Mateo"]},
  {id:9,title:"Pequeña & Grande: Frida",author:"María Isabel Sánchez",year:2015,pages:32,type:"Biografía",color:"#d36b35",cover:"linear-gradient(145deg,#245f57,#d74d58)",synopsis:"Una introducción luminosa a la vida y la imaginación de Frida Kahlo.",rating:4.4,available:1,copies:1,readers:["Sofía"]},
  {id:10,title:"Atlas de aventuras",author:"Rachel Williams",year:2014,pages:96,type:"Atlas",color:"#7e9445",cover:"linear-gradient(145deg,#213e55,#699c79)",synopsis:"Mapas ilustrados, rutas y maravillas para recorrer el planeta sin salir de casa.",rating:4.7,available:0,copies:1,readers:["Noa","Julia"]},
  {id:11,title:"El árbol generoso",author:"Shel Silverstein",year:1964,pages:64,type:"Álbum ilustrado",color:"#a85135",cover:"linear-gradient(145deg,#214638,#b9a256)",synopsis:"Una historia sencilla sobre el paso del tiempo, el afecto y la generosidad.",rating:4.5,available:1,copies:1,readers:["Mara","Leo"]},
  {id:12,title:"Cosmos para curiosos",author:"Carlotta James",year:2023,pages:152,type:"Divulgación",color:"#6f53a2",cover:"linear-gradient(145deg,#161c44,#855ab2)",synopsis:"Estrellas, planetas y grandes preguntas explicadas para exploradores del universo.",rating:4.6,available:1,copies:1,readers:["Mateo"]},
];

const people = [
  {name:"Elena",pages:3240,now:"El jardín secreto",emoji:"🌿",color:"#e8af78"},{name:"Mateo",pages:2984,now:"Cosmos para curiosos",emoji:"🪐",color:"#82a9c9"},{name:"Sofía",pages:2710,now:"Matilda",emoji:"✨",color:"#c99bc4"},{name:"Noa",pages:2488,now:"Atlas de aventuras",emoji:"🧭",color:"#8db7a0"},{name:"Julia",pages:2195,now:"El principito",emoji:"🌙",color:"#d3a365"},{name:"Leo",pages:1980,now:"Donde viven los monstruos",emoji:"👑",color:"#90a8d0"},{name:"Mara",pages:1832,now:"Cuentos de buenas noches",emoji:"🌸",color:"#d99191"},
];
const initialPosts=[
  {id:1,user:"Elena",book:"El jardín secreto",time:"Hace 12 min",text:"Tal vez un jardín no se abre con una llave, sino cuando alguien decide cuidarlo. Me gustó pensar que Mary florece al mismo ritmo que las plantas.",likes:18,replies:4,color:"#e8af78"},
  {id:2,user:"Mateo",book:"Cosmos para curiosos",time:"Hace 1 h",text:"La luz de algunas estrellas empezó su viaje antes de que naciéramos. Leerlo cambia un poco la forma de mirar la noche.",likes:12,replies:2,color:"#82a9c9"},
  {id:3,user:"Sofía",book:"Matilda",time:"Ayer",text:"Lo más poderoso de Matilda no es mover objetos: es conservar su curiosidad aunque nadie alrededor la comprenda.",likes:27,replies:7,color:"#c99bc4"},
];
...
export default function Home(){
  const [view,setView]=useState<View>("biblioteca"),[selected,setSelected]=useState<Book>(books[0]),[search,setSearch]=useState(""),[year,setYear]=useState(""),[type,setType]=useState("");
  const readBooks=[books[0],books[2],books[4],books[5]];
  const [owned,setOwned]=useState<Book|null>({...books[1],progress:36}),[toast,setToast]=useState(""),[modal,setModal]=useState<"detail"|"return"|"profile"|null>(null),[posts,setPosts]=useState(initialPosts),[draft,setDraft]=useState(""),[publishing,setPublishing]=useState(false),[postBook,setPostBook]=useState(readBooks[0].title),[liked,setLiked]=useState<number[]>([]),[reactionCounts,setReactionCounts]=useState<Record<string,number>>({}),[reactionBusy,setReactionBusy]=useState<string[]>([]);
  ...
  const sortedBooks=useMemo(()=>[...books].sort((a,b)=>a.title.localeCompare(b.title,"es",{sensitivity:"base"})),[]);
    ...
    fetch("/api/posts")
      ...
      .then(payload=>{
        if(!cancelled&&Array.isArray(payload.posts)){
          setPosts([...payload.posts,...initialPosts]);
        }
      })
      .catch(error=>{
  ...
  const takeBook=()=>{if(selected.available<1){flash("Ese ejemplar está en préstamo. Te avisaremos cuando vuelva.");return}if(owned){flash("Devuelve tu lectura actual antes de tomar otra.");return}setOwned({...selected,progress:0});setModal(null);flash(`“${selected.title}” ya está en tu poder.`)};
